...
function CourtHeader({ court }) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-8">
      ...
      <div className="flex flex-row sm:flex-col items-center justify-between sm:justify-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-4 rounded-2xl shadow-lg w-full sm:w-auto">
