...
from .views import PaymentList, PaymentDetail, WompiCheckoutView, WompiWebhookView, PaymentStatusView
...
urlpatterns = [
    ...
    path('wompi/status/', PaymentStatusView.as_view(), name='payment-status'),
]
